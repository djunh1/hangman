...
Scripts need to be executable.  In the ~/.myapp/hangman/bin directory, run the following:
$ sudo chmod +x *.sh
...
Step 5: Migrate the application Database ( from myapp/hangman)
$ rails db:migrate

The application will create the necessary tables to run the application.
